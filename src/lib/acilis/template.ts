...
export const ACILIS_SABLON: AcilisSablon[] = [
  ...
  { gate: 'G6', offset: 21, dept: 'Satın Alma', task: 'QİDA sifarişləri verilir — SON TARİX', cond: null, note: '21 gün öncə bağlanır. Açılış səhifəsi → Sifariş → «Departamentə göndər»' },
  { gate: 'G6', offset: 21, dept: 'Satın Alma', task: 'QEYRİ-QİDA sifarişləri verilir — SON TARİX', cond: null, note: '21 gün öncə bağlanır. Açılış səhifəsi → Sifariş → «Departamentə göndər»' },
