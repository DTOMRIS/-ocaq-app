...
export const ACILIS_SABLON: AcilisSablon[] = [
  ...
  { gate: 'G5', offset: null, dept: 'OPS', task: 'Mimari layihə komanda tərəfindən təsdiqlənir', cond: null, note: '4-cü addım — təsdiq olmadan tikintiyə başlanmır' },
  ...
  { gate: 'G6', offset: 7, dept: 'Bilgi İşlem', task: 'Barmaq izi (PDKS) cihazı quraşdırılır və şəbəkəyə bağlanır', cond: null, note: 'İşçi qeydiyyatından ƏVVƏL hazır olmalıdır' },
  { gate: 'G6', offset: 5, dept: 'İK', task: 'İşçilər barmaq izi sistemində qeydiyyatdan keçir', cond: null, note: 'Cihaz quraşdırıldıqdan sonra — açılış günü iş vaxtı düzgün sayılsın' },
