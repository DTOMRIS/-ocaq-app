...
export const ACILIS_SABLON: AcilisSablon[] = [
  ...
  { gate: 'G2', offset: null, dept: 'İdari İşlər', task: 'Kirayə müqaviləsi hazırlanır və imzalanır', cond: null, note: '1-ci addım — yerləşim və proyekt işi bundan sonra başlayır' },
  ...
  // Zəncir: müqavilə → komanda yerləşimi → proyekt → komanda təsdiqi → təhvil.
  // Sıra qeydlərdə nömrələnib: siyahı departament üzrə çeşidləndiyi üçün
  // ekranda yan-yana düşmür, amma «hansı əvvəl?» sualı cavabsız qalmır.
  { gate: 'G5', offset: null, dept: 'OPS', task: 'Shaurma komandası sahədə funksiya və yerləşimi müəyyən edir və memara verir', cond: null, note: '2-ci addım — memarın girdisi. Proyekt bundan ƏVVƏL çıxarılmır' },
  { gate: 'G5', offset: null, dept: 'İnşaat', task: 'İnşaat proyekti çıxarılır', cond: null, note: '3-cü addım — komandanın yerləşim sənədindən sonra' },
  { gate: 'G5', offset: null, dept: 'Rəhbərlik', task: 'Mimari layihə rəhbərlik tərəfindən təsdiqlənir', cond: null, note: '4-cü addım — təsdiq olmadan tikintiyə başlanmır. Son imza rəhbərlikdədir' },
  { gate: 'G5', offset: null, dept: 'OPS', task: 'Yer tikinti departamentinə təhvil verilir — elektrik, su, açar və texniki detaylar', cond: null, note: '5-ci addım — təhvil-təslim aktı imzalanır, əksiklər yazılır' },
  { gate: 'G5', offset: null, dept: 'İnşaat', task: 'Smeta və iş qrafiki təsdiqlənir, vendorla müqavilə imzalanır', cond: null, note: 'Açılış tarixi YALNIZ bundan sonra' },
  { gate: 'G5', offset: null, dept: 'İnşaat', task: 'İnşaat başlayır', cond: null, note: null },
  { gate: 'G5', offset: null, dept: 'OPS', task: 'Yerində həftəlik inşaat iclası — onlayn və yerində nəzarət', cond: null, note: 'Proyektə uyğunluq YERİNDƏ yoxlanılır, protokol yazılır' },
  ...
  { gate: 'G6', offset: 7, dept: 'Bilgi İşlem', task: 'Barmaq izi cihazı (giriş-çıxış qeydiyyatı) quraşdırılır və şəbəkəyə bağlanır', cond: null, note: 'İşçi qeydiyyatından ƏVVƏL hazır olmalıdır' },
  { gate: 'G6', offset: 5, dept: 'İK', task: 'İşçilərin barmaq izi sistemə yazılır', cond: null, note: 'Cihaz quraşdırıldıqdan sonra — açılış günü iş vaxtı düzgün sayılsın' },
  { gate: 'G6', offset: 7, dept: 'Bilgi İşlem', task: 'Filial Wolt hesabına əlavə edildi və inteqrasiya edildi', cond: 'catdirilma', note: 'Şəbəkə hesabı artıq var — yeni hesab açılmır' },
  { gate: 'G6', offset: 7, dept: 'Bilgi İşlem', task: 'Filial Bolt Food hesabına əlavə edildi və inteqrasiya edildi', cond: 'catdirilma', note: 'Şəbəkə hesabı artıq var — yeni hesab açılmır' },
  ...
  { gate: 'G6', offset: 7, dept: 'OPS', task: 'Canlı çiçək sifarişi (zal)', cond: 'oturma', note: 'Zalı olan filialda — marketinq işi deyil' },
  ...
  { gate: 'G6', offset: 5, dept: 'OPS', task: 'İnşaat tamamlandı və təhvil alındı, əksiklər siyahısı verildi', cond: null, note: 'Siyahı çap/PDF kimi çıxarılıb tikintiyə göndərilir' },
  { gate: 'G6', offset: 2, dept: 'OPS', task: 'Əksiklər siyahısındakı bütün maddələr tamamlanır — son yoxlama', cond: null, note: 'Açılışdan əvvəl bağlanmayan əksik qalırsa yazılı qeyd edilir' },
  ...
  { gate: 'G5', offset: null, dept: 'Satın Alma', task: 'Su analizi — filtr seçimi bundan sonra', cond: null, note: 'Analiz olmadan filtr seçilmir' },
  { gate: 'G5', offset: null, dept: 'Satın Alma', task: 'Su filtr sistemi — TƏK sistem, bütün bağlantılar planlanır', cond: null, note: 'Qəhvə, kola premiks, buz maşını, samovar eyni filtrə bağlanır — ayrı filtr alınmır' },
  ...
  { gate: 'G5', offset: null, dept: 'Marketinq', task: 'El ilanı — dizayn, çap və paylanma', cond: null, note: 'Bayraq sifariş edilmir — açılışda şar dekorasiyası var (G6)' },
  { gate: 'G5', offset: null, dept: 'Marketinq', task: 'Məhsul etiketləri', cond: null, note: null },
  { gate: 'G5', offset: null, dept: 'Marketinq', task: 'Qapıya iş saatları stikeri — dizayn, çap, yapışdırma', cond: null, note: 'G6-dakı təkrar sətirlə birləşdirildi' },
  { gate: 'G5', offset: null, dept: 'Marketinq', task: 'Ayaqlı poster / pano', cond: null, note: null },
  { gate: 'G5', offset: null, dept: 'Marketinq', task: 'SMM kontent planı', cond: null, note: 'Səhifələr artıq var — açmaq lazım deyil' },
  { gate: 'G5', offset: null, dept: 'Marketinq', task: '«Tezliklə» baneri — dizayn, sifariş və sosial mediada paylaşım', cond: null, note: 'Filial hazır görünəndə paylaşılır' },
  { gate: 'G5', offset: null, dept: 'Marketinq', task: 'SMM reklam mətni hazırlanır və təsdiqlənir', cond: null, note: 'Mətn təsdiqlənmədən reklam verilmir' },
  { gate: 'G5', offset: null, dept: 'Marketinq', task: 'SMM reklamının verilməsi', cond: null, note: 'Yalnız mətn təsdiqləndikdən sonra' },
  ...
  { gate: 'G5', offset: null, dept: 'İnşaat', task: 'Arxa giriş qapısına pəncərə + milçək toru (sineklik)', cond: null, note: 'HACCP' },
  { gate: 'G5', offset: null, dept: 'İnşaat', task: 'Giriş/çıxış EXIT və təhlükə işıqları', cond: null, note: 'yanğın tələbi' },
  { gate: 'G5', offset: null, dept: 'İnşaat', task: 'Davlumbaz altı işıqlandırma', cond: null, note: 'davlumbaz altı iş səthi qaranlıq qalır' },
  { gate: 'G5', offset: null, dept: 'İnşaat', task: 'Teras üçün tente / çətir konstruksiyası', cond: 'teras', note: null },
  ...
  { gate: 'G6', offset: 5, dept: 'Satın Alma', task: 'Milçək üçün ultraviole cihazı (içəri)', cond: null, note: 'HACCP' },
  { gate: 'G6', offset: 5, dept: 'Bilgi İşlem', task: 'UPS cihazları (kassa + POS + soyuducu)', cond: null, note: 'kəsintidə məhsul itkisi' },
  { gate: 'G5', offset: null, dept: 'Satın Alma', task: 'Zal stasionları', cond: 'oturma', note: null },
  { gate: 'G5', offset: null, dept: 'Satın Alma', task: 'Cola premix sistemi və qurulumu', cond: null, note: 'Su filtrinə bağlanır — su analizi ilə birlikdə planlanır' },
  { gate: 'G6', offset: 5, dept: 'Marketinq', task: 'Pilon (ayaqlı işıqlı tabela)', cond: 'format!=\'mall\'', note: null },
  { gate: 'G6', offset: 5, dept: 'Marketinq', task: 'Tente üzərinə brendinq', cond: 'teras', note: null },
  { gate: 'G6', offset: 2, dept: 'Marketinq', task: 'Qapıya «İTƏLƏ / ÇƏK» stikeri', cond: null, note: null },
  { gate: 'G6', offset: 21, dept: 'Satın Alma', task: 'QİDA sifarişləri verilir — SON TARİX', cond: null, note: 'Bu tarixdən sonra sifariş qəbul edilmir. Açılış səhifəsi → Sifariş → «Departamentə göndər»' },
  { gate: 'G6', offset: 21, dept: 'Satın Alma', task: 'QEYRİ-QİDA sifarişləri verilir — SON TARİX', cond: null, note: 'Bu tarixdən sonra sifariş qəbul edilmir. Açılış səhifəsi → Sifariş → «Departamentə göndər»' },
  { gate: 'G6', offset: 3, dept: 'OPS', task: 'Açılışdan ƏVVƏL dərmanlama (ilaçlama) icra olunur', cond: null, note: 'müqavilə deyil, İCRA' },
  ...
  { gate: 'G6', offset: 7, dept: 'Marketinq', task: 'Foto və video çəkiliş komandası sifariş edilir, tarix təsdiqlənir', cond: null, note: null },
  { gate: 'G6', offset: 7, dept: 'Marketinq', task: 'DJ və musiqi proqramı sifariş edilir, tarix təsdiqlənir', cond: null, note: null },
  ...
  { gate: 'G5', offset: null, dept: 'İnşaat', task: 'Barda ƏL YUMA lavabosu proyektə salınır', cond: 'bar', note: 'sanitar tələb' },
  { gate: 'G5', offset: null, dept: 'İnşaat', task: 'Zaldan bara qapı tipi (kovboy / ortası şüşəli gəmici qapısı)', cond: 'bar', note: null },
