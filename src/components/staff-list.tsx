...
// ─── Main Component ───────────────────────────────────────────────────────────
export default function StaffList({ staff, branches, userRole }: StaffListProps) {
    ...
    <div>
      ...
      <div style={{
        ...
        {(userRole === 'super_admin' || userRole === 'region_manager') && (
          <span style={{
            maxWidth: '310px', padding: '9px 12px', borderRadius: '8px',
            background: '#f8fafc', border: '1px solid #e2e8f0',
            color: '#64748b', fontSize: '11px', lineHeight: 1.5,
          }}>
            Personel burada kayıt olarak yönetilir; OCAQ giriş hesabı ve e-posta daveti açılmaz.
          </span>
        )}
      </div>
