...
export const metadata = { title: 'KXT Yoxlama — OCAQ' }
  ...
  return (
    <div>
      ...
      <p style={{ fontSize: '13px', color: '#888', margin: '0 0 32px' }}>
        Dijital checklist, SOP uyğunluğu və vardiya yoxlamaları
      </p>
      <div style={{
        ...
        <p style={{ fontSize: '13px', color: '#999', margin: 0 }}>
          KXT yoxlama modulu hazırlanır — açılış, bağlanış və vardiya checklist-ləri burada olacaq.
        </p>
      </div>
    </div>
  )
